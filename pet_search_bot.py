...
# определим словари с наборами ответов
...
def welcome_message(message):
    # бот предлагает юзеру выбрать приют
...
def shelter_callback_query(call):
    ...
    for p in pets_buttons:
        if call.data == p:
            ...
            connect = sqlite3.connect('pet_search_bot/shelters.db', check_same_thread=False)
            ...
            if user_data == p_zoopomosch_cats:
                ...
                # сохраняем результаты в переменной records
